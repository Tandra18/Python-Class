...
tk.Label(root, text="၁။ _____၊ ကျွန်တော်က ဂေးလေ။  (၁၀ မှတ်)",font=myanmar_font).pack(anchor='w',padx=10)
...
tk.Button(root, text="ဝန်ခံမယ်", command=show_choice,font=myanmar_font).pack(pady=10)
